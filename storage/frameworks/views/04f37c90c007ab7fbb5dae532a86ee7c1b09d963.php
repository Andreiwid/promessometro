     ...
     <div class="container navbartop-m">
        ...
        <div id="navbar1" class="navbar-collapse collapse navbar-right">
                <ul class="nav navbar-nav ; col-sm-12">
                    ...
                    <h1 class="subtitulo4" style="color:white;">
                    <?php 
            ...
            <ul class="nav navbar-nav">
                ...
                <div class="navbarlogin">
                    <form action="<?php echo url('validacao.php') ?>" method="post">
                        ...
                        <div class="formlogin">
                            <li>
                                <label for="email">Email
                                    <input type="email" name="email_validacao" style="font-family:Agency FB"></input>
                                </label>
                            </li>
                        </div>
                        <div class="formlogin">
                        ...
                        <div class="formlogin">
                            <li>
                                <a href="tipoCadastro"><button class="btn btn-default btn-sm navbar-btn-fontsize">Cadastre-se</button></a>
                            </li>
                        </div>
                    </div>
                </section>
