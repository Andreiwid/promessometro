      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-2 height-div">
            ...
            <button class="button-theme" onclick="javascript:location.href='/public/temaMetaIndicador/1/<?php echo e($cidade->ID_CIDADE); ?>'">
          ...
          <div class="col-md-2 height-div">
            ...
            <button class="button-theme" onclick="javascript:location.href='/public/temaMetaIndicador/2/<?php echo e($cidade->ID_CIDADE); ?>'">
