                    ...
                    <form action="meta/atualizar" method="post">
                        <div style="word-wrap: break-word;">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-2"><?php echo e($aux->ID_TEMA); ?></div>
                                <div class="col-md-3"><?php echo e($aux->OBJETIVO); ?></div>
                                <div class="col-md-1" style="padding: 0px;">100,0</div>
                                <div class="col-md-2"><?php echo e($aux->ID_GESTAO); ?></div>
                                <div class="col-md-2"><?php echo e($aux->DATA_INICIO); ?></div>
                                <div class="col-md-2"><?php echo e($aux->DATA_FIM); ?></div>
