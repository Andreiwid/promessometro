    ...
    <div class="middlecenter-cadastra">
      <div class="row">
        ...
        <input type = "hidden" name="ID_META" value="<?php echo e($page->ID_META); ?>">
          ...
          <h1 class="subtitulo promeblue"><?php if($percentual_meta_total <1): ?><img src="../img/vermelha.png">
										  <?php elseif($percentual_meta_total >= 1 && $percentual_meta_total < 100): ?><img src="../img/amarela.png">
											<?php else: ?><img src="../img/verde.png">
										  <?php endif; ?> 
										  META | <?php echo e($page->DESCRICAO); ?></h1>
          <div class="col-md-10">
            <div id="testcircle"></div>
          </div>
           
		      <?php if($row == 0 ): ?>
            <form action= "<?php echo e($page->ID_META); ?>/SeguirMeta" method="post" name="form_follow">
          ...
          <?php elseif($row > 0): ?>
            <form action= "<?php echo e($page->ID_META); ?>/DeixaSeguir" method="post" name="form_unfollow">
        ...
        <div class="row" >
          <div class="col-md-6">
            ...
            <?php foreach($acao as $auxacao): ?>
                  ...
                  <?php endif; ?>
            <?php endforeach; ?>
            <h1 class="subtitulo subtitulo-barra promeblue"> <?php echo e($contadoracaocompleta); ?> de <?php echo e($acaocount); ?> ações da Meta:</h1>
                ...
                <input type="checkbox" name="accordion" id="accordion-<?php echo e($auxacao->ID_ACAO); ?>" />
                  ...
                  <div class="accordion-content">
                    <div class="col-md-12 justificafonte">
                      ...
                      <div class="col-md-4" >
                        <P class="subtitulo4 promeblue">Prefeitura prestacao de contas <?php echo e(date('Y', strtotime($page->DATA_INICIO))); ?>-<?php echo e(date('Y', strtotime($page->DATA_FIM))); ?></P>
                      </div>
                    </div>
                    <div class="col-md-12" >
                      <hr class="gradient-line">
                      <div class="col-md-2" >
                        <P class="texto"><?php echo e($auxacao->RESPONSAVEIS); ?></P>
                      </div>
                      <div class="col-md-2" >
                      ...
                      <div class="col-md-2" >
                        <P class="texto"><?php echo e(date('d/m/Y', strtotime($auxacao->DATA_FIM))); ?></P>
                      </div>
                      <div class="col-md-4">
                      <?php foreach($pca as $pcaaux3): ?>
                        <?php if($pcaaux3->ID_ACAO == $auxacao->ID_ACAO): ?>
                          <P class="texto"><?php echo e(date('d/m/Y', strtotime($pcaaux3->DATA_REFERENCIA))); ?>: <?php echo e($pcaaux3->CONSIDERACAO); ?></P>
                        <?php endif; ?>
                      <?php endforeach; ?>
                      </div>
                      <hr>
