                    ...
                    <h1 class="titulo promeblue">Cadastro de Usuários</h1>
                        <div class="row">
                            ...
                            <select class="smallinput inputlist" name="cidade">
                                <?php foreach($cidade as $aux): ?>
                                    <option value="<?php echo e($aux->ID_CIDADE); ?>"><?php echo e($aux->NOME); ?></option>
                                <?php endforeach; ?>
                            </select> 
                            </div>
                            ...
                            <select class="smallinput inputlist" name="estado">
                                <?php foreach($estado as $aux): ?>
                                    <option value="<?php echo e($aux->ID_ESTADO); ?>"><?php echo e($aux->NOME); ?></option>
                                <?php endforeach; ?>
                            </select> 
                              <label class="promeblue subtitulo3">Tipo Usuario:</label>
                            <select class="smallinput inputlist" name="tipo_usuario">
                                <?php foreach($tipo_usuario as $aux): ?>
                                    <option value="<?php echo e($aux->ID_TIPO_USUARIO); ?>"><?php echo e($aux->DESCRICAO); ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="container">
                        <div class="col-md-6 rightline">    
                            ...
                            <select class="smallinput inputlist" name="id_gestao">
                                <?php foreach($gestao as $aux): ?>
                                            <option value="<?php echo e($aux->ID_GESTAO); ?>"><?php echo e($aux->ID_GESTAO); ?></option>
                                <?php endforeach; ?>
                            </select>
