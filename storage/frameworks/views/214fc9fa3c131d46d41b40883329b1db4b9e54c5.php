                ...
                <div class="col-md-8 major-box-validation">
                    ...
                    <div class="col-md-9">
                        <P class="texto-validation centralizafonte">
                            Uma mensagem de confirmação foi enviada para o seu email.
                            ...
                            <P class="texto-validation centralizafonte">
                             <strong>ATENÇÃO!</strong>, Se o usuário ter a finalidade de cadastrar mais metas, ações ou indicadores, por favor acesse seus dados para complementação do cadastro </p>
                            </P>
                           </div>
                       </div>
                       <div class="col-md-2"></div>
